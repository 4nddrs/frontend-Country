      ...
      <div className="bg-white/5 p-6 rounded-2xl mb-8 text-[#F8F4E3] border border-slate-700">
        ...
        <div className="mt-8 flex justify-end gap-3">
          <button
            ...
            className="relative h-12 overflow-hidden rounded bg-neutral-950 px-5 py-2.5 transition-all duration-300 cursor-pointer hover:bg-[#3CC9F6]/15 hover:ring-2 hover:ring-[#3CC9F6]/60 hover:ring-offset-2"
          >
            <span className="relative inline-flex items-center gap-2 text-[#3CC9F6]"><Plus size={15} /> Crear Reporte</span>
          </button>
        </div>
      </div>
