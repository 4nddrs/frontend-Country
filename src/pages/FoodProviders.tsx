...
const FoodProvidersManagement = () => {
  ...
  return (
    <div className="container mx-auto p-4 text-white">
      <h1 className="text-3xl font-bold mb-6 text-center">Gestión de Proveedores de Alimento</h1>
      <div className="bg-gray-800 p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="flex gap-4">
          ...
          <input
            ...
            className="flex-1 p-2 rounded-md bg-gray-700 text-white placeholder-gray-400"
          />
          <button onClick={createProvider} className="bg-green-600 hover:bg-green-700 text-white p-2 rounded-md font-semibold flex items-center gap-2">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {providers.map(provider => (
              <div key={provider.idFoodProvider} className="bg-gray-700 p-4 rounded-md shadow-lg flex flex-col justify-between">
                {editingId === provider.idFoodProvider ? (
                  <>
                    ...
                    <div className="flex justify-end gap-2">
                      <button
                        onClick={() => updateProvider(provider.idFoodProvider!, {
                  ...
                  <>
                    ...
                    <div className="flex justify-end gap-2 mt-2">
                      <button
                        onClick={() => { setEditingId(provider.idFoodProvider!); setNewProvider(provider); }}
