...
const API_URL = 'https://backend-country-nnxe.onrender.com/vaccination_plan_application/';
const BASE_URL = 'https://backend-country-nnxe.onrender.com';
                    ...
                    <>
                      ...
                      <div className="flex justify-end gap-2 mt-4">
                        <button
                          ...
                          className="bg-yellow-600 hover:bg-yellow-700 text-white p-2 rounded-md flex items-center gap-1 transition duration-300"
                        >
                          <Edit size={16} /> Editar
                        </button>
                        <button
                          onClick={() => deleteApplication(app.idVaccinationPlanApplication!)}
                          className="bg-red-600 hover:bg-red-700 text-white p-2 rounded-md flex items-center gap-1 transition duration-300"
                        >
