              ...
              <div className="relative p-4 md:p-6 flex items-center justify-between min-h-[80px]">
                <div className="flex items-center gap-3 md:gap-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base md:text-lg text-white font-semibold mb-1 truncate">{horse.horseName}</h3>
                    <p className="text-xs md:text-sm text-slate-400 truncate">{horse.race?.nameRace || 'Sin raza'} · {calculateAge(horse.birthdate)} años</p>
                  </div>
                </div>
          ...
          <div className="relative p-4 md:p-6 flex items-center justify-between min-h-[80px]">
            <div className="flex items-center gap-3 md:gap-4 flex-1">
              ...
              <div className="flex-1">
                <h3 className="text-base md:text-lg text-white font-semibold mb-1">Cámara activa</h3>
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-slate-800/60 to-slate-900/60 border border-slate-700/50 backdrop-blur-md shadow-lg">
          <div className="p-4 md:p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="group flex gap-3 p-3 md:p-4 rounded-xl bg-slate-800/60 hover:bg-slate-800/80 active:scale-[0.98] transition-all cursor-pointer border border-slate-700/30">
                <span className="text-2xl md:text-xl mt-0.5 flex-shrink-0">🌱</span>
                <p className="text-sm md:text-sm text-slate-200 leading-relaxed">Se renovaron las áreas verdes del establo principal.</p>
              </div>
              
              <div className="group flex gap-3 p-3 md:p-4 rounded-xl bg-slate-800/60 hover:bg-slate-800/80 active:scale-[0.98] transition-all cursor-pointer border border-slate-700/30">
                <span className="text-2xl md:text-xl mt-0.5 flex-shrink-0">💧</span>
                <p className="text-sm md:text-sm text-slate-200 leading-relaxed">Mantenimiento del sistema de agua el próximo fin de semana.</p>
              </div>
            </div>
          </div>
        </Card>
